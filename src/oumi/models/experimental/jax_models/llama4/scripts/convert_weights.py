...
"""Convert HuggingFace Llama4-architecture models to JAX format
Based on jax-llm-examples/llama4/scripts/convert_weights.py
"""
...
def main(model_path: str | Path, ckpt_path: str | Path):
    ...
    cfg = l4jax.hf_to_jax_config(config.to_dict())
    ...
    # Llama4 model checkpoints are distributed unquantized
    weights = l4jax.Weights.abstract(cfg)
